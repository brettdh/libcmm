...
LOCAL_SRC_FILES := \
    ../../libcmm_scout.cpp \
    $(addprefix ../../../, debug_ext.cpp cmm_thread.cpp timeops.cpp libcmm_net_restriction.cpp)
LOCAL_CFLAGS += -DBUILDING_SCOUT_SHLIB -DBUILDING_EXTERNAL -DNDK_BUILD -g -ggdb -std=c++11
